...
if [ $split_train_data -eq 1 ]; then
  ...
  utils/subset_data_dir.sh --shortest $train_acoustic_dir 800 ${data_dir}/train-2k-shortest
  utils/subset_data_dir.sh $train_acoustic_dir 2000  ${data_dir}/train-5k
  utils/subset_data_dir.sh $train_acoustic_dir 4000 ${data_dir}/train-10k
fi
...
if [ "$prep_train_lang" -eq "1" ]; then
  ...
  prompt_rm_dir ${data_dir}/local ${data_dir}/lang_nosp
